...
<head>
    ...
    <title>Absen PT. Tiga Mitra Surabaya | Login</title>
                    ...
                    <section id="login-body" class="pt-3">
                        <div class="card border-0 shadow pt-3">
                            <div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
                                <img src="<?= base_url('assets/img/logo type.png') ?>" alt="Logo PT. Tiga Mitra Surabaya" class="img-fluid mx-auto d-block">
                                <div class="mt-3">
                                    <span class="card-info text-center">Masuk Untuk Melakukan Absensi Online</span>
                                </div>
                            </div>
                            <div class="card-body">
