...
<head>
    ...
    <title>Absensi PT Tiga Mitra Surabaya</title>
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/logo type.png') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2019 <a href="https://www.tigamitra.co.id/">PT Tiga Mitra Surabaya</a>
                        </p>
                    </nav>
                </div>
            </footer>
